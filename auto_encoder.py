...
from inc_conv_gru import INCEP_ConvGRUCell
...
class Auto_encoder(object):
    ...
    def build_graph(self, in_data):
        ...
        for i in range(len(self.gru_filters)):
            if self.incept:
                self.encoder_rnn_blocks.append(INCEP_ConvGRUCell(num_filter=self.gru_filters[i],
                                                                 b_h_w=(
                                                                     self.batch,
                                                                     feature_map_H[i],
                                                                     feature_map_W[i]
                                                                    ),
                                                                 i2h_kernel=c.EN_GRU_INCEPTION_I2H[i],
                                                                 h2h_kernel=c.EN_GRU_INCEPTION_H2H[i],
                                                                 name="e_cgru_" + str(i),
        ...
        for i in range(len(self.gru_filters)):
            if self.incept:
                self.decoder_rnn_blocks.append(INCEP_ConvGRUCell(num_filter=self.gru_filters[i],
                                                                 b_h_w=(
                                                                     self.batch,
                                                                     feature_map_H[i],
                                                                     feature_map_W[i]
                                                                 ),
                                                                 i2h_kernel=c.DE_GRU_INCEPTION_I2H[i],
                                                                 h2h_kernel=c.DE_GRU_INCEPTION_H2H[i],
                                                                 name="d_cgru_" + str(i),
