...
BASE_PATH = '/extend/gru_tf_data/gru_experiment/incept_gru'
...
EN_GRU_INCEPTION_I2H=[
    ([5,5,GEN_ENCODER_GRU_INCHANEL[0],GEN_ENCODER_GRU_FILTER[0]//2*3],[3,3,GEN_ENCODER_GRU_INCHANEL[0],GEN_ENCODER_GRU_FILTER[0]//2*3]),
    ([4,4,GEN_ENCODER_GRU_INCHANEL[1],GEN_ENCODER_GRU_FILTER[1]//2*3],[3,3,GEN_ENCODER_GRU_INCHANEL[1],GEN_ENCODER_GRU_FILTER[1]//2*3]),
    ([4,4,GEN_ENCODER_GRU_INCHANEL[2],GEN_ENCODER_GRU_FILTER[2]//2*3],[3,3,GEN_ENCODER_GRU_INCHANEL[2],GEN_ENCODER_GRU_FILTER[2]//2*3]),
]
EN_GRU_INCEPTION_H2H=[
    ([5,5,GEN_ENCODER_GRU_FILTER[0],GEN_ENCODER_GRU_FILTER[0]//2*3],[3,3,GEN_ENCODER_GRU_FILTER[0],GEN_ENCODER_GRU_FILTER[0]//2*3]),
    ([4,4,GEN_ENCODER_GRU_FILTER[1],GEN_ENCODER_GRU_FILTER[1]//2*3],[3,3,GEN_ENCODER_GRU_FILTER[1],GEN_ENCODER_GRU_FILTER[1]//2*3]),
    ([4,4,GEN_ENCODER_GRU_FILTER[2],GEN_ENCODER_GRU_FILTER[2]//2*3],[3,3,GEN_ENCODER_GRU_FILTER[2],GEN_ENCODER_GRU_FILTER[2]//2*3]),
]

DE_GRU_INCEPTION_I2H=[
    ([5,5,GEN_DECODER_GRU_INCHANEL[0],GEN_DECODER_GRU_FILTER[0]//2*3],[3,3,GEN_DECODER_GRU_INCHANEL[0],GEN_DECODER_GRU_FILTER[0]//2*3]),
    ([4,4,GEN_DECODER_GRU_INCHANEL[1],GEN_DECODER_GRU_FILTER[1]//2*3],[3,3,GEN_DECODER_GRU_INCHANEL[1],GEN_DECODER_GRU_FILTER[1]//2*3]),
    ([4,4,GEN_DECODER_GRU_INCHANEL[2],GEN_DECODER_GRU_FILTER[2]//2*3],[3,3,GEN_DECODER_GRU_INCHANEL[2],GEN_DECODER_GRU_FILTER[2]//2*3]),
]

DE_GRU_INCEPTION_H2H=[
    ([5,5,GEN_DECODER_GRU_FILTER[0],GEN_DECODER_GRU_FILTER[0]//2*3],[3,3,GEN_DECODER_GRU_FILTER[0],GEN_DECODER_GRU_FILTER[0]//2*3]),
    ([4,4,GEN_DECODER_GRU_FILTER[1],GEN_DECODER_GRU_FILTER[1]//2*3],[3,3,GEN_DECODER_GRU_FILTER[1],GEN_DECODER_GRU_FILTER[1]//2*3]),
    ([4,4,GEN_DECODER_GRU_FILTER[2],GEN_DECODER_GRU_FILTER[2]//2*3],[3,3,GEN_DECODER_GRU_FILTER[2],GEN_DECODER_GRU_FILTER[2]//2*3]),
]
