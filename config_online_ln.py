...
def check_dir(dir):
    if not os.path.exists(dir):
        os.makedirs(dir)
BASE_PATH='/extend/gru_tf_data/gru_experiment/ln_multi_scale_221_online'
...
TEST_RADAR_PNG_PATH='/extend/2020_png/'
...
TEST_TIME=[
    ...
    # ['202003240800','202003241400']
    ['202003240600','202003270000']
    ]
TRAIN_SEQ=40000
VALID__SEQ=1000
...
resize=1
#generator--------------------------------
GEN_ENCODER_GRU_FILTER=(96,192,192)
GEN_ENCODER_GRU_INCHANEL=(16+resize,192+resize,192+resize)
GEN_CONV_KERNEL = ((7, 7, 1, 16),
               (5, 5, 96,192),
               (3, 3, 192, 192))
GEN_CONV_STRIDE = (3, 2, 2)
GEN_DECONV_KERNEL = ((7, 7, 16, 96),
                 (5, 5, 192, 192),
                 (4, 4, 192, 192))
GEN_DECONV_STRIDE = (3, 2, 2)
GEN_DECODER_GRU_FILTER= (96, 192, 192)
GEN_DECODER_GRU_INCHANEL = (192, 192, 192)
