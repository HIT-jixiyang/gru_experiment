...
def check_dir(dir):
    if not os.path.exists(dir):
        os.makedirs(dir)
BASE_PATH='/extend/gru_tf_data/gru_experiment/mae_mse_resize_ssim_grad1_grad2_max'
...
TEST_TIME=[
    ...
    # ['201904110000','201904130000'],
    # ['201904190000','201904210000'],
    # ['201904200800','201904201206'],
